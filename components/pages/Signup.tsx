...
export default function Signup({ navigate }: SignupProps) {
  ...
  const { signup, loginWithGoogle, googleEnabled } = useAuth()
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer', marginTop: 4 }}>
            ...
            <span style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.5 }}>
              I agree to the{' '}
              <button onClick={() => navigate('home')} type="button" style={{ color: 'var(--accent-cyan)', textDecoration: 'none', background: 'none', border: 'none', cursor: 'pointer' }}>Terms of Service</button>
              {' '}and{' '}
              <button onClick={() => navigate('home')} type="button" style={{ color: 'var(--accent-cyan)', textDecoration: 'none', background: 'none', border: 'none', cursor: 'pointer' }}>Privacy Policy</button>
            </span>
          </label>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-secondary)', textAlign: 'center', marginTop: 24 }}>
          ...
          <button onClick={() => navigate('login')} style={{ color: 'var(--accent-cyan)', fontWeight: 600, background: 'none', border: 'none', cursor: 'pointer' }}>Log In</button>
        </p>
      </div>
    </div>
  )
